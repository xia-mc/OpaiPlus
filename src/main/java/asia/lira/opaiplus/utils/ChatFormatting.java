...
public enum ChatFormatting {
    ...
    private static final Map<String, ChatFormatting> nameMapping = new HashMap<>();
    ...
    public static @NotNull Collection<String> getValidValues(final boolean p_96296_0_, final boolean p_96296_1_) {
